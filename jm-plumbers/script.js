/* ============================================================
   J&M Plumbers — interactions
   Kept minimal on purpose: this audience skews older homeowner, so the
   phone number is a plain tel: link on every screen and nothing on the
   conversion path needs JavaScript to work.
   ============================================================ */
(function () {
  'use strict';
