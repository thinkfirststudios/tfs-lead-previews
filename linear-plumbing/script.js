/* ============================================================
   Linear Plumbing — interactions
   Nothing on the conversion path depends on JavaScript: the phone
   number is a plain tel: link in the header, hero, emergency strip,
   operator block and sticky bar. JS only adds the reveal, the
   accordion, and the emergency nudge on the form.
   ============================================================ */
(function () {
  'use strict';
