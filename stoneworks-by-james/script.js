/* Stoneworks by James — interactions
   Condensing header · hero parallax · scroll reveals · count-up
   · keyboard-navigable lightbox · filterable masonry gallery
   · FAQ accordion · demo consultation form
...
(function () {
  ...
  var gItems = document.querySelectorAll('#gGrid .m-item');
  ...
  document.querySelectorAll('.form').forEach(function (form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (!status) return;
      if (ok) {
  status.textContent = 'Thanks — your estimate request is ready. Demo only: this form still needs connecting to James.';
      } else {
